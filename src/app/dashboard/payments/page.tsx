...
const HISTORY = [
  { id: "PMT-2025-001", date: "2025-01-12", desc: "Annual Renewal 2025", amount: "RWF 50,000", status: "Verified" },
  { id: "PMT-2024-008", date: "2024-01-09", desc: "Annual Renewal 2024", amount: "RWF 50,000", status: "Verified" },
  { id: "PMT-2023-012", date: "2023-01-15", desc: "Annual Renewal 2023", amount: "RWF 45,000", status: "Verified" },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground font-sans">Track your subscription payments, certificates, and annual renewals.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
          ...
          <CardContent className="flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <div className="text-sm text-muted-foreground">Next renewal due</div>
                <div className="text-lg font-bold text-navy mt-0.5">31 Dec 2025 · RWF 50,000</div>
              </div>
            </div>
            <Button 
              className="bg-gold text-[#1a1a1a] hover:bg-gold/90 shadow-gold border-none font-semibold shrink-0" 
              onClick={() => toast.success("Proof uploaded successfully — pending administrative verification")}
            >
        ...
        <Card className="border-zinc-100 dark:border-zinc-800">
          <CardContent className="p-6">
            ...
            <div className="mt-2 text-xs text-muted-foreground">5 successful verification cycles</div>
          </CardContent>
        </Card>
      </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-navy/5 dark:bg-navy/10 border-b border-zinc-100 dark:border-zinc-800">
                  ...
                  <TableHead className="text-navy font-semibold">Description</TableHead>
              ...
              <TableBody>
                {HISTORY.map((h, i) => (
                  ...
                  >
                    <TableCell className="font-mono text-xs text-zinc-600 dark:text-zinc-400">{h.id}</TableCell>
                    <TableCell className="text-sm text-zinc-700 dark:text-zinc-350">{h.date}</TableCell>
                    <TableCell className="text-sm">{h.desc}</TableCell>
                    <TableCell className="font-semibold text-zinc-900 dark:text-zinc-100">{h.amount}</TableCell>
                    <TableCell>

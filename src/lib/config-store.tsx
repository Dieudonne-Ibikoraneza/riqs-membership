...
const DEFAULTS: AppConfig = {
  ...
  categories: [
    ...
    { id: "firm_local_small", name: "Local Small Firm", description: "Annual turnover less than 50 Million RWF",
      documents: [
        { id: "rdb", name: "Firm Business Registration Certificate (RDB) Indicating shareholding", required: true },
        { id: "rra_tax", name: "Rwanda Revenue Authority (RRA) Tax Clearance", required: true },
        { id: "rssb_tax", name: "RSSB Tax Clearance Certificate", required: false },
        { id: "prof_members", name: "Valid Certificates of RIQS Professional Members employed (At least one)", required: true },
        { id: "other_members", name: "Other RIQS Members employed in Firm (At least two)", required: true },
        { id: "proof_of_payment", name: "Proof of Payment (Registration Fee)", required: false },
      ] },
    { id: "firm_local_medium", name: "Local Medium Firm", description: "Annual turnover between 50-100 Million RWF",
      documents: [
        { id: "rdb", name: "Firm Business Registration Certificate (RDB) Indicating shareholding", required: true },
        { id: "rra_tax", name: "Rwanda Revenue Authority (RRA) Tax Clearance", required: true },
        { id: "rssb_tax", name: "RSSB Tax Clearance Certificate", required: false },
    ...
    { id: "firm_local_large", name: "Local Large Firm", description: "Annual turnover above 100 Million RWF",
      documents: [
        { id: "rdb", name: "Firm Business Registration Certificate (RDB) Indicating shareholding", required: true },
        { id: "rra_tax", name: "Rwanda Revenue Authority (RRA) Tax Clearance", required: true },
        { id: "rssb_tax", name: "RSSB Tax Clearance Certificate", required: false },
    ...
    { id: "firm_foreign_small", name: "Foreign Small Firm", description: "Annual turnover less than 100,000 USD",
      documents: [
        { id: "origin_rdb", name: "Firm Business Registration Certificate (Country of Origin)", required: true },
        { id: "tax_clearance", name: "Valid Tax Clearance Certificate", required: true },
        { id: "social_security", name: "Social Security Clearance Certificate", required: false },
        { id: "proof_of_payment", name: "Proof of Payment (Registration Fee)", required: false },
      ] },
    { id: "firm_foreign_medium", name: "Foreign Medium Firm", description: "Annual turnover between 100,000-500,000 USD",
      documents: [
        { id: "origin_rdb", name: "Firm Business Registration Certificate (Country of Origin)", required: true },
        { id: "tax_clearance", name: "Valid Tax Clearance Certificate", required: true },
        { id: "social_security", name: "Social Security Clearance Certificate", required: false },
    ...
    { id: "firm_foreign_large", name: "Foreign Large Firm", description: "Annual turnover above 500,000 USD",
      documents: [
        { id: "origin_rdb", name: "Firm Business Registration Certificate (Country of Origin)", required: true },
        { id: "tax_clearance", name: "Valid Tax Clearance Certificate", required: true },
        { id: "social_security", name: "Social Security Clearance Certificate", required: false },

...
import { Award, Wallet, FileText, GraduationCap, BadgeCheck, ArrowRight, Calendar } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-bold md:text-3xl">{me.applicantName}</h1>
            <div className="mt-2 flex items-center gap-2">
              <BadgeCheck className="h-4 w-4 text-gold fill-gold" />
              <span className="font-mono text-sm">RIQS-2025-001</span>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 stagger">
        {[
          { i: Award, label: "Membership Category", v: "Professional", c: "text-navy" },
          { i: Wallet, label: "Last Payment", v: "RWF 50,000", c: "text-emerald-600" },
          { i: GraduationCap, label: "CPD Hours Logged", v: "24 / 40", c: "text-amber-600" },
          { i: FileText, label: "Uploaded Documents", v: "8 on file", c: "text-navy" },
        ].map((s, index) => (
          <motion.div
            key={s.label}
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="md:col-span-2 border-zinc-100 dark:border-zinc-800">
          <CardHeader>
            <CardTitle className="text-navy">Continuing Professional Development</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between text-sm font-sans">
              <span className="text-zinc-600 dark:text-zinc-400">2025 progress</span>
              <span className="font-semibold text-navy">24 / 40 hours completed</span>
            </div>
